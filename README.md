...
6. If you did everything correct, https://rickykenny.github.io/redocTest/ will lead to your new docs
...
- Documentation(ReDoc): https://rickykenny.github.io/redocTest/
- SwaggerUI: https://rickykenny.github.io/redocTest/swagger-ui/
- Look full spec:
    + JSON https://rickykenny.github.io/redocTest/swagger.json
    + YAML https://rickykenny.github.io/redocTest/swagger.yaml
- Preview spec version for branch `[branch]`: https://rickykenny.github.io/redocTest/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://rickykenny.github.io/redocTest/ with url from the message: `Server started <url>`
